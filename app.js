...
const E = [
  ...
  {date:"8 Mart 2025",y:2025,cat:"kadin",title:"TJA — 8 Mart Dünya Emekçi Kadınlar Günü Mitingi",desc:"Özgür Kadın Hareketi (TJA) 8 Mart mitinginde barış çağrısını yükseltti. 'Savaş değil barış, baskı değil özgürlük; kadın yaşamı özgürleştirir' sloganları meydanlarda yankılandı.",url:"https://jinnews.org"},
  ...
  {date:"19 Temmuz 2025",y:2025,cat:"sivil",title:"TTB — Barış için İmza Kampanyası",desc:"Türk Tabipleri Birliği, barış sürecine destek amacıyla imza kampanyası başlattı. Binlerce sağlık çalışanı 'Sağlık için barış, barış için sağlık' çağrısını imzaladı.",url:"https://www.ttb.org.tr"},
  ...
  {date:"15 Kasım 2025",y:2025,cat:"sivil",title:"Batman Barosu — Barış Süreci Paneli",desc:"Batman Barosu, hukukçu ve sivil toplum temsilcilerini bir araya getiren panel düzenledi. Barış sürecinin hukuki boyutu ve yerel dinamikler tartışıldı.",url:"https://bianet.org"},
  ...
  {date:"10 Aralık 2025",y:2025,cat:"sivil",title:"İHD & TİHV — 10 Aralık İnsan Hakları Günü, İstanbul",desc:"İnsan Hakları Derneği ve Türkiye İnsan Hakları Vakfı, İstanbul'da 10 Aralık İnsan Hakları Günü kapsamında ortak basın açıklaması gerçekleştirdi. Barış sürecinde insan hakları güvencelerinin önemi vurgulandı.",url:"https://tihv.org.tr/basin-aciklamalari/"},
  {date:"11 Aralık 2025",y:2025,cat:"sivil",title:"KAFFED — Barış Sürecine Destek Açıklaması",desc:"Kafkas Dernekleri Federasyonu, Kürt sorununda barışçıl çözüme destek veren açıklama yayımladı. 'Kalıcı barış, toplumun tüm kesimlerinin katılımıyla mümkündür' dedi.",url:"https://bianet.org"},
  {date:"12 Aralık 2025",y:2025,cat:"siyasi",title:"'Ekmek ve Barış için Bütçe' Yürüyüşü",desc:"Emek ve barış örgütleri, Türkiye bütçesinin militarizm yerine eğitim, sağlık ve barış inşasına ayrılması talebiyle yürüyüş düzenledi.",url:"https://bianet.org"},
  {date:"13 Aralık 2025",y:2025,cat:"sivil",title:"'Barış İçin Adalet' Buluşması",desc:"İnsan hakları ve hukuk örgütleri 'Barış İçin Adalet' buluşmasında bir araya geldi. Geçiş dönemi adaleti mekanizmaları ve hesap verebilirlik tartışıldı.",url:"https://bianet.org"},
  {date:"13 Aralık 2025",y:2025,cat:"sivil",title:"İHD İstanbul — Çocuk Hakları ve Barış Konferansı",desc:"İHD İstanbul Şubesi, barış sürecinde çocuk haklarını konu alan konferans düzenledi. Silahlı çatışmanın çocuklar üzerindeki etkileri ve çözüm önerileri paylaşıldı.",url:"https://www.ihd.org.tr"},
  {date:"13 Aralık 2025",y:2025,cat:"sivil",title:"TTB — Sağlık, Barış ve Demokrasi Çalıştayı",desc:"Türk Tabipleri Birliği, 13–14 Aralık tarihlerinde 'Sağlık, Barış ve Demokrasi' çalıştayı düzenledi. Sağlık çalışanlarının barış sürecindeki rolü ve talepleri tartışıldı.",url:"https://www.ttb.org.tr"},
  {date:"18 Aralık 2025",y:2025,cat:"kadin",title:"Barışa İhtiyacım Var — 'Ekmek ve Barış için Bütçe' açıklaması",desc:"Barışa İhtiyacım Var inisiyatifi, Türkiye bütçesine ilişkin feminist perspektiften açıklama yayımladı: 'Silaha değil barışa, savaşa değil yaşama bütçe istiyoruz.'",url:"https://www.barısaihtiyacimvar.com/"},
  ...
  {date:"26 Aralık 2025",y:2025,cat:"kadin",title:"Leyla Zana'yı Anma — Barış Tezahüratları",desc:"Kürt siyasi tarihinin sembolik figürü Leyla Zana'nın serbest bırakılışının yıl dönümünde barış aktivistleri bir araya geldi; barış süreci için kadın dayanışmasına vurgu yapıldı.",url:"https://bianet.org"},
  {date:"28 Aralık 2025",y:2025,cat:"rojava",title:"İran'daki Kürt Bölgelerine Yönelik Saldırı Protestoları",desc:"İran'daki Kürt bölgelerine yönelik gelişmeler üzerine Türkiye'nin çeşitli kentlerinde protesto eylemleri düzenlendi. Eylemciler barış ve dayanışma çağrısında bulundu.",url:"https://bianet.org"},
  ...
  {date:"18 Ocak 2026",y:2026,cat:"sivil",title:"'Ölüye Saygı ve Adalet' Paneli",desc:"Sivil toplum kuruluşları ve insan hakları savunucularının bir araya geldiği panelde geçiş dönemi adaleti, kayıpların araştırılması ve toplumsal hafıza meseleleri tartışıldı.",url:"https://politikahaber.com/34-sivil-toplum-orgutunden-forum-baris-icin-ortak-mucadele-sart/"},
  ...
  {date:"20 Ocak 2026",y:2026,cat:"kadin",title:"Barışa İhtiyacım Var — İstanbul Harbiye ABD Başkonsolosluğu eylemi",desc:"BİV üyeleri Harbiye'deki ABD Başkonsolosluğu önünde toplandı; Kobanê'ye yönelik saldırılara ses çıkarmayan uluslararası toplum protesto edildi.",url:"https://bianet.org/haber/rojava-icin-sokaga-cikan-kadinlar-hts-erkek-siddetinin-yeni-adi-315831"},
  {date:"21 Ocak 2026",y:2026,cat:"rojava",title:"Nusaybin — Suriye'deki Kürt bölgelerine saldırı protestosu",desc:"Nusaybin'de halk, Suriye'deki Kürt bölgelerine yönelik süregelen saldırıları protesto etmek amacıyla toplandı. 'Kobanê düşmez, Rojava direniyor' sloganları atıldı.",url:"https://bianet.org/haber/rojava-icin-sokaga-cikan-kadinlar-hts-erkek-siddetinin-yeni-adi-315831"},
  ...
  {date:"22 Ocak 2026",y:2026,cat:"kadin",title:"Barışa İhtiyacım Var — İzmir eylemi",desc:"BİV İzmir bileşeni, Rojava'ya yönelik saldırıları protesto etmek amacıyla İzmir'de basın açıklaması düzenledi.",url:"https://bianet.org/haber/rojava-icin-sokaga-cikan-kadinlar-hts-erkek-siddetinin-yeni-adi-315831"},
  {date:"23 Ocak 2026",y:2026,cat:"kadin",title:"Mersin Kadın Platformu — Rojava'ya Saldırıları Durdurun",desc:"Mersin Kadın Platformu üyeleri Mersin'de bir araya gelerek Rojava'daki sivillere yönelik saldırıları protesto etti ve barış çağrısında bulundu.",url:"https://bianet.org/haber/rojava-icin-sokaga-cikan-kadinlar-hts-erkek-siddetinin-yeni-adi-315831"},
  ...
  {date:"26 Ocak 2026",y:2026,cat:"kadin",title:"Barış Anneleri — İstanbul eylemi serisi",desc:"Barış Anneleri İstanbul grupları, Rojava'daki gelişmeleri protesto etmek amacıyla ardı ardına eylem gerçekleştirdi. 'Savaş değil barış, baskı değil özgürlük' talepleri öne çıktı.",url:"https://bianet.org/haber/mursitpinar-sinir-kapisi-acilsin-guvenli-yasam-kosullari-saglansin-316151"},
  ...
  {date:"27 Ocak 2026",y:2026,cat:"kadin",title:"İHD Kadın Komisyonu — Rojava saldırılarına karşı basın açıklamaları",desc:"İHD Kadın Komisyonu ülke genelinde il şubeleri aracılığıyla eş zamanlı basın açıklamaları gerçekleştirdi. 'Rojava'daki kadınlara yönelik saldırılar insanlığa karşı suçtur' denildi.",url:"https://www.ihd.org.tr"},
  ...
  {date:"28 Ocak 2026",y:2026,cat:"kadin",title:"Barış Anneleri — ABD Başkonsolosluğu önü eylemi",desc:"Barış Anneleri, Kobanê ve Rojava'ya yönelik saldırılara uluslararası toplumun sessiz kalması protesto amacıyla ABD Başkonsolosluğu önünde eylem gerçekleştirdi.",url:"https://mezopotamyaajansi35.com"},
  ...
  {date:"29 Ocak 2026",y:2026,cat:"kadin",title:"Barış Anneleri — Suriye Başkonsolosluğu önü eylemi",desc:"Barış Anneleri, Rojava'daki sivillere yönelik saldırılar nedeniyle Suriye Başkonsolosluğu önünde basın açıklaması yaptı. 'Annelerimizin acısı dinmiyor; barış kadınların hakkıdır' dendi.",url:"https://bianet.org/haber/mursitpinar-sinir-kapisi-acilsin-guvenli-yasam-kosullari-saglansin-316151"},
  {date:"29 Ocak 2026",y:2026,cat:"sivil",title:"Barış Vakfı — Rojava saldırılarına ilişkin açıklama",desc:"Barış Vakfı, Rojava'da yaşanan gelişmelerin Türkiye barış sürecini tehdit ettiğini vurgulayan açıklama yayımladı. Vakıf: 'Kalıcı barış Kürt meselesinin tüm boyutlarıyla ele alınmasını gerektiriyor' dedi.",url:"https://barisvakfi.org"},
  ...
  {date:"27 Şubat 2026",y:2026,cat:"pkk",title:"Öcalan'ın İkinci Çağrısı — Süreçte Yeni Sayfa",desc:"Barış ve Demokratik Toplum Çağrısı'nın 1. Yıl Buluşması'nda DEM Parti heyeti, Öcalan'ın ikinci çağrısını kamuoyuyla paylaştı. Çağrıda demokratik müzakere sürecinin derinleştirilmesi ve anayasal güvenceye kavuşturulması talep edildi.",url:"https://bianet.org/haber/surecte-yeni-sayfa-abdullah-ocalan-in-ikinci-cagrisi-kime-ne-anlama-geliyor-317177"},
  {date:"3 Mart 2026",y:2026,cat:"sivil",title:"İHD — 'Barış Yasaları' Çağrısı",desc:"İnsan Hakları Derneği, barış sürecinin hukuki zeminine oturtulması için 'Barış Yasaları' başlıklı kapsamlı bir çağrı yayımladı. İHD: 'Silahsızlanma sonrası demokratik uzlaşının yasal güvence altına alınması şarttır' dedi.",url:"https://www.ozgurpolitika.com"},
  {date:"7 Mart 2026",y:2026,cat:"kadin",title:"TJA — 8 Mart Barış Çağrısı, Van",desc:"Özgür Kadın Hareketi (TJA) 8 Mart Dünya Emekçi Kadınlar Günü öncesinde Van'da basın açıklaması düzenledi. 'Barış kadınların emeğiyle örülür' mesajı öne çıktı.",url:"https://jinnews.org/TUM-HABERLER/content/view/276519"},
  {date:"21 Mart 2026",y:2026,cat:"siyasi",title:"Newroz 2026 — Diyarbakır'da Yüz Binler Barış Dedi",desc:"Diyarbakır'da düzenlenen Newroz kutlamalarına yüz binler katıldı. Meydanda yükselen en güçlü ses 'barış' oldu. DEM Parti eş genel başkanları: 'Newroz'un ateşi barışı aydınlatıyor' dedi.",url:"https://bianet.org/haber/diyarbakirda-yuzbinler-2026-newrozunda-bulustu-baris-diye-seslendi-317912"}
];

const CONNS = [
  [0,1,"siyasi"],[1,3,"siyasi"],[3,12,"pkk"],[12,20,"pkk"],[20,26,"pkk"],[26,31,"pkk"],[31,48,"pkk"],[48,54,"tbmm"],[54,64,"tbmm"],
  [2,16,"kadin"],[16,19,"kadin"],[19,22,"kadin"],[22,30,"kadin"],[30,45,"kadin"],[45,49,"kadin"],[49,52,"kadin"],[52,56,"kadin"],[56,68,"kadin"],[68,73,"kadin"],[73,81,"kadin"],[81,86,"kadin"],
  [34,35,"tbmm"],[35,37,"tbmm"],[37,38,"tbmm"],[38,39,"tbmm"],[39,54,"tbmm"],[54,64,"tbmm"],
  [5,9,"sivil"],[9,17,"sivil"],[17,43,"sivil"],
  [67,75,"rojava"],[75,76,"rojava"],[76,83,"rojava"],[83,89,"rojava"],
  [7,18,"sivil"],[18,25,"sivil"]
];
